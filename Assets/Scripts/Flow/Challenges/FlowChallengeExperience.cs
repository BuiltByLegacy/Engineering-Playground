...
namespace EngineeringPlayground.Flow.Challenges
{
    ...
    {
        private FlowChallengePlayController _play; private FlowChallengeSession _session; private FlowTouchEditor _editor; private PipeHandleOverlay _pipeHandles; private GameObject _toolDock; private GameObject _resultCard; private Text _hint; private Button _primaryButton; private Text _primaryLabel; private Button _nextButton; private bool _challengeModeActive=true;
        private ProductionToast _toast; private ProductionResultSheet _sheet; private GameObject _hintRoot;

        public void Configure(FlowChallengePlayController play,FlowChallengeSession session,FlowTouchEditor editor,PipeHandleOverlay pipeHandles,GameObject toolDock,GameObject resultCard,Text hint,Button primaryButton,Text primaryLabel,Button nextButton)
        {
            _play=play;_session=session;_editor=editor;_pipeHandles=pipeHandles;_toolDock=toolDock;_resultCard=resultCard;_hint=hint;_primaryButton=primaryButton;_primaryLabel=primaryLabel;_nextButton=nextButton;
        ...
        private void Refresh()
        {
            ...
            if(tutorial&&!results)
            {
                ...
                _hint.text=running?"Watch the flow stay inside the pipe. Smooth bends waste less energy.":"DRAG the teal handles to shape the pipe, then RUN FLOW.";
            }
